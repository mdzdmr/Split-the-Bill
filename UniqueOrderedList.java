public class UniqueOrderedList<T extends Comparable<T>> implements SimpleIterable<T>, UniqueOrderedListADT<T> {
	...
	public CopyableIterator<T> iterator() {
		// Return an iterator that starts at the beginning of the list
